...
export default function PatientProfile() {
  ...
  useEffect(() => {
    ...
    async function patientGetter() {
      setParentId(localStorage.getItem("patientRecord"));
    
      if (localStorage.getItem("patientRecord")&&web5){
  ...
  return (
    <div className="text-white flex flex-col min-h-screen justify-center items-center">
      <div className=" w-[40rem] text-xl h-[25rem] bg-blue-800 rounded-md flex   flex-col justify-center text-center gap-5">
        <img
